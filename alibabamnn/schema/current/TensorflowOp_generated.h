...
enum BinaryOpOperation {
  ...
  BinaryOpOperation_MAX = BinaryOpOperation_FLOORMOD
};

inline const BinaryOpOperation (&EnumValuesBinaryOpOperation())[18] {
...
inline const char *EnumNameBinaryOpOperation(BinaryOpOperation e) {
  if (e < BinaryOpOperation_ADD || e > BinaryOpOperation_FLOORMOD) return "";
