...
inline const OpType (&EnumValuesOpType())[136] {
...
enum OpParameter {
  ...
  OpParameter_MAX = OpParameter_DetectionPostProcessParam
};

inline const OpParameter (&EnumValuesOpParameter())[83] {
...
inline const char *EnumNameOpParameter(OpParameter e) {
  if (e < OpParameter_NONE || e > OpParameter_DetectionPostProcessParam) return "";
  const size_t index = static_cast<int>(e);
...
inline const flatbuffers::TypeTable *OpTypeTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_ENUM, 136, type_codes, type_refs, values, names
  };
  return &tt;
}
...
inline const flatbuffers::TypeTable *OpParameterTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_UNION, 83, type_codes, type_refs, nullptr, names
  };
  return &tt;
}
